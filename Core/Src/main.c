...
volatile uint8_t firstEdgeCapatured = 0;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(measurementReady){
		  ...
		  int len = snprintf(msg, sizeof(msg), "This is the distance: %0.2lf", distance);
